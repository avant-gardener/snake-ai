...
if mode == "1":
    ...
    print("First Generation Average Fitness: {0}".format(Population.get_average(this_generation)))
    print(this_generation)
    for j in range(generation_count):
        this_generation = Population.new_generation(this_generation)
        print("Generation number: {0}  Average Fitness: {1}".format(j, Population.get_average(this_generation)))
        print(this_generation)
